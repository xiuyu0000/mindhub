...
@register_model(model_name="fcn8s_vgg16_voc2012",
                model_type="image/segmentation",
                paper="https://arxiv.org/abs/1411.4038",
                pretrained=True)
class FCN8SVGG16VOC2012:
    def __init__(self,
                 model_name: str = "fcn8s_vgg16_voc2012",
                 pretrained: bool = False,
                 weight_path: Optional[str] = None,
                 num_classes: int = 21):
        self.net = FCN8s(num_classes) \
            if model_name == "fcn8s_vgg16_voc2012" else None
        self.ckpt_url = "https://download.mindspore.cn/models/r1.9/fcn8s_ascend_v190_voc2012_" \
                        "official_cv_meanIoU62.7.ckpt"
            ...
            if (i + 1) % batch_size == 0 or i == len(images_path) - 1:
                ...
                for ri, res in enumerate(results):
                    ...
                    if t_classes:
                        ...
                        print(f"{filename} has been segmented to classes: "
                              f"{[NAME_CLASSES[r] for r in t_classes if r != 0]}.")
                    else:
...
if __name__ == "__main__":
    model = FCN8SVGG16VOC2012(pretrained=True)
    model.infer(data_path="./data",
                output_path="./outputs")
